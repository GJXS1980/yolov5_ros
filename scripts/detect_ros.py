...
class detect:
    def __init__(self):
        ...
        self.data_pub = rospy.Publisher("yolov5_data", Float32MultiArray, queue_size=1)
    ...
    def run(
            ...
            # weights=self.weights,  # model.pt path(s)
            # source=self.source,  # file/dir/URL/glob, 0 for webcam
            # data=self.data,  # dataset.yaml path
